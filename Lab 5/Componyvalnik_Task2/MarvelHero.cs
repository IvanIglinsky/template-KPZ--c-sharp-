namespace DesignPatterns.Composite
{
  class MarvelHero
  {
    ...
    public void AddFriend(MarvelHero marvelHero)
    {
      Console.WriteLine("Now you are friends with {0}",marvelHero.Name);
      
    }

    public void RemoveFriend(MarvelHero marvelHero)
    {
      Console.WriteLine("Now you are NOT friends with {0}",marvelHero.Name);
    }
