...
using static BlackJack.PointsCounter;
...
namespace BlackJack
{
  public class GameState
  {
    ...
    public List<Player> GetWinners()
    {
      ...
      return this._players.Aggregate(new System.Collections.Generic.List<Player>(), (System.Collections.Generic.List<Player> winners, Player next) => {
        int? nextPlayerPointsCount = CountWinningPoints(next.DrawnCards);
        
        int? currentWinningPoints = winners.Count > 0 ? CountWinningPoints(winners[0].DrawnCards) : null;
